...
## 3.2.12 (2024-12-19) - Instamatic Rebrand
### Major Changes
- **Complete rebrand from GramAddict to Instamatic**
- **Updated tested Instagram version to 330.0.0.40.92**
- **Removed all "buy me a coffee" messages and donation requests**
- **Comprehensive new README with professional documentation**
- **Updated all branding, URLs, and references throughout codebase**
- **Enhanced .gitignore for cleaner repository**

### Improvements
- Professional branding and documentation
- Cleaner codebase without promotional content
- Updated project metadata and configuration
- Improved user experience with comprehensive tutorials
...
* place first post not found [#208](https://github.com/Instamatic/bot/issues/208)

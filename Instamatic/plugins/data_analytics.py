    ...
    def run(self, device, configs, storage, sessions, plugin):
        logger.warning(
            """Analytics have been removed due to a problem in some OS with loading matplotlib.
                            ...
                            with the one inside the release 2.0.8 https://github.com/Instamatic/bot/releases/tag/2.0.8
                            For see where this file is located in your machine, just write 'pip shown Instamatic' and you will get the path.
                            """
        )

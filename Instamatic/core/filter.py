...
from Instamatic.core.config import get_time_last_save
...
from Instamatic.core.views import FollowStatus, ProfileView
    ...
    def __init__(self, storage=None):
        ...
        if self.conditions is not None:
            ...
            if not args.disable_filters:
                logger.warning(
                    f"The filters file doesn't exists in your account folder (can't find {filter_path}). Download it from https://github.com/Instamatic/bot/blob/08e1d7aff39ec47543fa78aadd7a2f034b9ae34d/config-examples/filters.yml and place it in your account folder!"
                )

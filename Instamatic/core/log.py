...
class LoggerFilterInstamaticOnly(logging.Filter):
    def filter(self, record: LogRecord):
        return record.name.startswith("Instamatic")
...
def create_log_file_handler(filename):
    ...
    file_handler.addFilter(LoggerFilterInstamaticOnly())
    return file_handler
...
def configure_logger(debug, username):
    ...
    console_handler.addFilter(LoggerFilterInstamaticOnly())

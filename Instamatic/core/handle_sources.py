...
from Instamatic.core.device_facade import Direction, Timeout
from Instamatic.core.navigation import (
    nav_to_blogger,
    nav_to_feed,
...
from Instamatic.core.storage import FollowingStatus
...
from Instamatic.core.views import (
    FollowingView,
    LikeMode,
    OpenedPostView,
    Owner,
        ...
        while True:
                ...
                for item in user_container:
                    try:
                        ...
                        if "UiObjectNotFoundException" in str(e) or "JsonRpcError" in str(e):
                            logger.debug(f"UI element disappeared during iteration, skipping: {str(e)}")
                            continue
                        else:
                            raise e
            ...
            if not opened:
                ...
                if posts_end_detector.is_skipped_limit_reached():
                    ...
                    # Return special value to indicate depletion for blogger removal
                    return "DEPLETED" if current_job == "blogger-post-likers" else None

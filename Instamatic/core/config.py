...
from Instamatic.core.plugin_loader import PluginLoader
...
class Config:
    def __init__(self, first_run=False, **kwargs):
        ...
        self.parser = configargparse.ArgumentParser(
            ...
            description="Instamatic Instagram Bot",
        )
    ...
    def load_plugins(self):
        self.plugins = PluginLoader("Instamatic.plugins", self.first_run).plugins
        self.actions = {}

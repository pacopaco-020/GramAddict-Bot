...
from Instamatic import __version__
from Instamatic.core.bot_flow import start_bot
from Instamatic.core.download_from_github import download_from_github
        ...
        for username in args.account_name:
            if not path.exists("./run.py"):
                ...
                download_from_github(
                    "https://github.com/Instamatic/bot/blob/master/run.py"
                )
            if not path.exists(f"./accounts/{username}"):
                print(
                    f"Creating 'accounts/{username}' folder with a config starting point inside. You have to edit these files according with the README configuration guide."
                )
                download_from_github(
                    "https://github.com/Instamatic/bot/tree/master/config-examples",
